namespace eTime.DomainModel
{
    ...
    [Table("TimeSheetApprovalRequestItemHoldPEARRefresh")]
    public class TimeSheetApprovalRequestItemHoldPEARRefresh
    {
        public int TimeSheetApprovalRequestItemHoldPEARRefreshID { get; set; }
